...
{\tt http://jakevdp.github.io/blog/2014/03/11/frequentism-and-bayesianism-a-practical-intro/}}. For those with a statistics background,
I recommend the books by \citet{ohagan} and \citep{gelman}.
...
implementation. It has some advantages over other Monte Carlo methods, but it
...
distributions in moderate dimensions. It is particularly useful in
...
\bibitem[\protect\citeauthoryear{Stan Development Team}{2014}]{stan}
