...
small region of parameter space. The integral will be dominated by the values
...
MultiNest \citep{multinest} is one of the most popular implementations of
Nested Sampling.

Emcee \citep{emcee} is useful for getting quick, efficient results on low
...
JAGS \citep{jags} ... (cite STATS331). The main advantage of JAGS is that it
...
having to worry too much about MCMC algorithms themselves.
