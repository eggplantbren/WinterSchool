...
trust them, and incorporate them literally into our sampling distribution like
...
the prior, and calculate their likelihoods.
\item Find the particle with the lowest likelihood, and save its properties.
\item 
\end{itemize}
