...
you would have been able to find the value of an unknown quantity when you had
enough information to determine its value with certainty.
In science, this hardly ever happens, which is why we need probability theory.

We'll donate our unknown parameters by $\btheta$, which could be a single
...
much difference if we just say it's a real number between 0 and 1 inclusive. The
distance to a star (measured in whatever units you like) is presumably a
