...
uncertainty we should have about our conclusions.
...
properties of your problem. At times, I will comment on other popular methods
that we are not covering, and their strengths and weaknesses.

There are many popular software packages available for doing Bayesian Inference, such as:
...
I won't be teaching you how to use any of these programs. If you or your collaborators already use one of them, that's a great reason to learn one!
